...
trainer = TrainLoop(in_size, args.d, args.nh, args.h, args.n_pseudo_inputs, torch.nn.functional.relu, optimizer, dataset, args.d, checkpoint_path=args.checkpoint_path, cuda=args.cuda)
